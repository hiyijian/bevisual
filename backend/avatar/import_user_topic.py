...
def import_user_history(infile, host, db, user, passwd):
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="import uesr topics")
	parser.add_argument("-f", help="user join topic file", required=True)
	args = parser.parse_args()
	import_user_history(args.f, "localhost", "viplog", "root", "root")
