...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="import uesr recommend list")
	parser.add_argument("-f", help="user recommend file", required=True)
	args = parser.parse_args()
	import_rlist(args.f, "localhost", "viplog", "root", "root")
