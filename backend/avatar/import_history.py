...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="import uesr history")
	parser.add_argument("-f", help="user hisotry file", required=True)
	args = parser.parse_args()
	import_history(args.f, "localhost", "viplog", "root", "root")
