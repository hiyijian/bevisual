...
if __name__ == "__main__":
        parser = argparse.ArgumentParser(description="import model view")
        parser.add_argument("-f", help="model view file", required=True)
        args = parser.parse_args()
        import_model_view(args.f, "localhost", "viplog", "root", "root")
